...
public class ConstructorWithOptionalTest {
    ...
    public static class ExecutiveOptional {
        private Salary salary;
        public ExecutiveOptional(@nawaman.defaultj.annotations.Optional Salary salary) {
            this.salary = salary;
        }
        public Salary salary() {
            return salary;
    ...
    public static class OwnerOptional {
        private Optional<Salary> salary;
        public OwnerOptional(@nawaman.defaultj.annotations.Optional Optional<Salary> salary) {
            this.salary = salary;
        }
        public Optional<Salary> salary() {
            return salary;
